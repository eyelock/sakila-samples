...
privileged aspect FilmController_Roo_Controller_Json {
    ...
    @ResponseBody
    public ResponseEntity<String> FilmController.showJson(@PathVariable("filmId") Short filmId) {
    ...
    public ResponseEntity<String> FilmController.updateFromJson(@RequestBody String json, @PathVariable("filmId") Short filmId) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        Film film = Film.fromJsonToFilm(json);
    ...
    public ResponseEntity<String> FilmController.deleteFromJson(@PathVariable("filmId") Short filmId) {
        Film film = filmService.findFilm(filmId);
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        if (film == null) {
