...
import net.eyelock.sakila.domain.CategoryIntegrationTest;
...
privileged aspect CategoryIntegrationTest_Roo_IntegrationTest {
    ...
    public void CategoryIntegrationTest.testFindCategory() {
        ...
        Assert.assertEquals("Find method for 'Category' returned the incorrect identifier", id, obj.getCategoryId());
    }
    ...
    public void CategoryIntegrationTest.testSaveCategory() {
        ...
        Assert.assertNull("Expected 'Category' identifier to be null", obj.getCategoryId());
        try {
        ...
        Assert.assertNotNull("Expected 'Category' identifier to no longer be null", obj.getCategoryId());
    }
