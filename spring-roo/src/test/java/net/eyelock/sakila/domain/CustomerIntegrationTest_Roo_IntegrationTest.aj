...
import net.eyelock.sakila.domain.CustomerIntegrationTest;
...
privileged aspect CustomerIntegrationTest_Roo_IntegrationTest {
    ...
    public void CustomerIntegrationTest.testFindCustomer() {
        ...
        Assert.assertEquals("Find method for 'Customer' returned the incorrect identifier", id, obj.getCustomerId());
    }
    ...
    public void CustomerIntegrationTest.testSaveCustomer() {
        ...
        Assert.assertNull("Expected 'Customer' identifier to be null", obj.getCustomerId());
        try {
        ...
        Assert.assertNotNull("Expected 'Customer' identifier to no longer be null", obj.getCustomerId());
    }
