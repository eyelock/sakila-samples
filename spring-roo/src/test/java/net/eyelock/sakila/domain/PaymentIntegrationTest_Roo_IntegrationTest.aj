...
import net.eyelock.sakila.domain.PaymentIntegrationTest;
...
privileged aspect PaymentIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    PaymentService PaymentIntegrationTest.paymentService;
    
    @Autowired
    PaymentRepository PaymentIntegrationTest.paymentRepository;
    
    @Test
    public void PaymentIntegrationTest.testCountAllPayments() {
    ...
    public void PaymentIntegrationTest.testFindPayment() {
        ...
        obj = paymentService.findPayment(id);
        Assert.assertNotNull("Find method for 'Payment' illegally returned null for id '" + id + "'", obj);
        Assert.assertEquals("Find method for 'Payment' returned the incorrect identifier", id, obj.getPaymentId());
    }
    ...
    public void PaymentIntegrationTest.testFindPaymentEntries() {
        ...
        List<Payment> result = paymentService.findPaymentEntries(firstResult, maxResults);
    ...
    @Test
    public void PaymentIntegrationTest.testSavePayment() {
        Assert.assertNotNull("Data on demand for 'Payment' failed to initialize correctly", dod.getRandomPayment());
        ...
        Assert.assertNull("Expected 'Payment' identifier to be null", obj.getPaymentId());
        try {
        ...
        Assert.assertNotNull("Expected 'Payment' identifier to no longer be null", obj.getPaymentId());
    }
    
    @Test
    public void PaymentIntegrationTest.testDeletePayment() {
        Payment obj = dod.getRandomPayment();
        Assert.assertNotNull("Data on demand for 'Payment' failed to initialize correctly", obj);
        Short id = obj.getPaymentId();
        Assert.assertNotNull("Data on demand for 'Payment' failed to provide an identifier", id);
        obj = paymentService.findPayment(id);
        paymentService.deletePayment(obj);
        paymentRepository.flush();
        Assert.assertNull("Failed to remove 'Payment' with identifier '" + id + "'", paymentService.findPayment(id));
    }
