...
import net.eyelock.sakila.domain.CityIntegrationTest;
...
privileged aspect CityIntegrationTest_Roo_IntegrationTest {
    ...
    @Autowired
    CityRepository CityIntegrationTest.cityRepository;
    ...
    public void CityIntegrationTest.testFindCity() {
        ...
        Assert.assertEquals("Find method for 'City' returned the incorrect identifier", id, obj.getCityId());
    }
    ...
    public void CityIntegrationTest.testSaveCity() {
        ...
        Assert.assertNull("Expected 'City' identifier to be null", obj.getCityId());
        try {
        ...
        Assert.assertNotNull("Expected 'City' identifier to no longer be null", obj.getCityId());
    }
